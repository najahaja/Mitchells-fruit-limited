          ...
          <div className="bento-grid">
            ...
            <div className="bcard-vx sr-b bento-c5">
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "2px", height: "28px", marginTop: "14px" }}>
                {Array.from({ length: 10 }, (_, i) => <div key={i} style={{ width: "3px", borderRadius: "2px", background: i % 2 === 0 ? "#7F77DD" : "rgba(127,119,221,.3)", animation: `mwa 1.2s ease-in-out infinite`, animationDelay: `${[0, 0.1, 0.2, 0.1, 0, 0.1, 0.2, 0.3, 0.2, 0.1][i]}s` }} />)}
              </div>
            </div>
